-- 用户库0初始化脚本
-- 创建数据库
CREATE DATABASE IF NOT EXISTS user_db0 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- 插入测试数据
INSERT INTO t_user_0 (user_id, username, password, real_name, phone, email, gender, status) VALUES
(1, 'admin', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '管理员', '13800138000', 'admin@example.com', 1, 1);
